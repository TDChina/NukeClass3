...
def main():
    ...
    moveNode("Text1", 200 - toNode("Constant1").screenHeight(), 'y')
    moveNode("Constant1", 300, 'x')
    moveNode("Text1", 300, 'x')
    moveNode("Transform1", 300, 'x')

    moveNode("ColorBars1", 400, 'y')
    moveNode("ColorBars1", -220, 'x')
    ...
    toNode("ColorCorrect1").setXpos(toNode("Glow1").xpos()+350)
    ...
    toNode("ColorBars1").setYpos(toNode("Dot1").ypos() - 100)
    toNode("ColorBars1").setXpos(toNode("Dot1").xpos()-30)
